...
<div class="wrap">
    ...
    <div id="isotope-loops">
        ...
        <?php if ($isotope_loops) : ?>
            <p><?php _e('Here are the itsIsotope shortcodes you\'ve saved so far:', $this->plugin_slug); ?></p>
            <table class="widefat">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach ($isotope_loops as $isotope_loop) : ?>
                        ...
                        <tr>
                            ...
                            <td><input type='text' readonly='readonly' size='25' value='[itsisotope id="<?php echo $shortcode_id; ?>"]'></td>
                            <td>
    ...
    <div id="isotope-display-options" style="display:none;">
        <form method="post" action="options.php">
            <?php
            settings_fields('isotope_options');
            do_settings_sections('isotope-options');
            ?>
            <p class="submit">
