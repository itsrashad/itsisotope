    ...
    class Isotope_Posts_Settings {
        ...
        public function display_setting($args = array()) {
            ...
            switch ($type) {
                ...
                case 'text':
                default:
                    echo '<input class="regular-text' . $field_class . '" type="text" id="' . $id . '" name="isotope_options[' . $id . ']" placeholder="' . $std . '" value="' . esc_attr(isset($options[$id])) . '" />';
